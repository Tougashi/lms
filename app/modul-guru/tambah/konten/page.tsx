...
function RichTextEditor({ placeholder }: { placeholder: string }) {
    ...
    const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const res = await uploadApi.content(file, "MATERI_IMAGE");
            if (editorRef.current) {
                editorRef.current.focus();
                ...
                <div className="grid w-full gap-8 lg:grid-cols-[260px_1fr]">
                    ...
                    <section className="px-4 pb-8 pt-6 sm:px-6 lg:pr-6">
                        ...
                        <p className="mt-2 max-w-[620px] text-[12px] leading-[1.6] text-[#7e8290]">
                            Mulailah menyusun kursus Anda dengan membuat bagian,
                            pelajaran, dan aktivitas praktik (kuis, latihan
                            coding, dan tugas). Gunakan garis besar kursus untuk
                            menyusun konten serta melalui bagian dan pelajaran
                            Anda dengan jelas. Jika Anda berniat menawarkan
                            kursus secara gratis, total durasi konten video
                            untuk kursus tidak boleh melebihi 2 jam.
                        </p>
                            ...
                            >
                                ...
                                <div className="mt-5 rounded-xl border border-[#e5e3ee] px-4 py-4">
                                    ...
                                    <p className="mt-2 text-[11px] leading-[1.6] text-[#7a7e8a]">
                                        Kuis akan disajikan dalam bentuk studi
                                        kasus. Setiap satu cerita akan memiliki
                                        4 pertanyaan turunan berdasarkan pilar
