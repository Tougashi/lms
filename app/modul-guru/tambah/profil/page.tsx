      ...
      <div className="min-h-screen bg-[#f7f6fb] text-[#232530]">
        ...
        <div className="flex items-center justify-center py-20">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-[#8a8d98]">Memuat data modul...</p>
          </div>
        </div>
      </div>
    );
          ...
          <section className="px-4 pb-8 pt-6 sm:px-6 lg:pr-6">
            ...
            {isExpanded && (
              <div className="mt-6 space-y-4">
                  ...
                  <>
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <select className={inputClassName} value={level} onChange={(e) => setLevel(e.target.value)}>
                ...
                <div>
                  ...
                  <select className={inputClassName} value={difficulty} onChange={(e) => setDifficulty(e.target.value)}>
            ...
            <div className="mt-8 pb-6">
              {isExpanded ? (
                ...
                >
                  {isSaving ? 'Menyimpan...' : 'Simpan Profil Modul'}
                </button>
              ) : (
                <button
                  type="button"
