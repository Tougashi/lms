        ...
        <header className="sticky top-0 z-50 border-b border-[#eceaf4] bg-white shadow-sm">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        {isNotificationMenuOpen && (
                            <div className="absolute right-0 top-full z-50 mt-3 w-[380px] overflow-hidden rounded-[22px] border border-[#d7d9df] bg-white shadow-[0_18px_50px_rgba(0,0,0,0.22)]">
                                <div className="flex items-center justify-between border-b border-[#d7d9df] px-4 py-3">
                                    <h3 className="text-[1.05rem] font-bold text-[#202126]">
                                        Pemberitahuan
                                    </h3>
                                    <button
                                        type="button"
                                ...
                                <div className="max-h-[430px] overflow-y-auto">
                                    {notifications.length > 0 ? (
                                        notifications.map((item, index) => (
                                            ...
                                            >
                                                <h4 className="text-[0.95rem] font-bold text-[#202126]">
                                                    {item.title}
                                                </h4>
                                                <p className="mt-1.5 text-[0.88rem] leading-6 text-[#202126]">
                                                    {item.message}
                                                </p>
                    ...
                    <button
                        type="button"
                        className="hidden rounded-full p-2 hover:bg-[#f7f6ff] sm:inline-flex"
                        aria-label="Bantuan"
                    >
                        <RiCustomerService2Line
                            size={22}
                            className="text-[#21212b]"
                        />
                    </button>
            ...
            {isMobileNavOpen && (
                <div className="border-t border-[#eceaf4] bg-white px-4 py-3 sm:hidden">
                    <nav className="flex flex-col gap-2 text-[14px]">
                        <Link
                            href="/beranda-guru"
                            className={`rounded-lg px-3 py-2 ${isBerandaActive ? "bg-[#f0ecff] font-medium text-[#7054dc]" : "text-[#21212b]"}`}
                        >
                            Beranda
                        </Link>
                        <Link
                            href="/modul-guru"
                            className={`rounded-lg px-3 py-2 ${isModulActive ? "bg-[#f0ecff] font-medium text-[#7054dc]" : "text-[#21212b]"}`}
                        >
                            Modul Saya
                        </Link>
                        <Link
                            href="/tentang-kami"
                            className="rounded-lg px-3 py-2 text-[#21212b]"
                        >
                            Tentang Kami
                        </Link>
                    </nav>
