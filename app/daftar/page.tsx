...
export default function DaftarPage() {
    ...
    const selectedJenjangLabel =
        jenjangOptions.find((item) => item.value === jenjang)?.label || "";
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            ...
            if (
                jenjangDropdownRef.current &&
                !jenjangDropdownRef.current.contains(target)
            ) {
                setIsJenjangOpen(false);
            }

            if (
                kelasDropdownRef.current &&
                !kelasDropdownRef.current.contains(target)
            ) {
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label
                                htmlFor="namaLengkap"
                                className="block text-sm font-medium text-[#21212b] mb-2"
                            >
                                Nama Lengkap
                            </label>
                            <input
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-8">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-sm text-[#21212b]">
                                        Siswa
                                    </span>
                                </label>
                                <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <p className="text-center text-[#8a8a96] text-sm mt-6">
                        ...
                        <Link
                            href="/login"
                            className="text-[#7054dc] hover:text-[#5d42b0] font-medium transition-colors"
                        >
                            Login
                        </Link>
                    </p>
