                ...
                <section className="w-full bg-gradient-to-r from-[#f9e8de] to-[#dce6ff] px-4 pb-24 pt-16 sm:px-7 lg:px-10">
                    <div className="mx-auto max-w-6xl">
                        <div className="text-center">
                            <h1 className="text-4xl font-bold text-[#7054dc] sm:text-5xl">
                                Tentang Kami
                            </h1>
                            <p className="mx-auto mt-6 max-w-4xl text-lg leading-relaxed text-[#444c5f]">
                                Sebuah platform manajemen modul yang dirancang
                                untuk membantu pengajar mengelola materi dan
                                memantau perkembangan siswa secara lebih efisien
                                dan terukur.
                            </p>
                        </div>
                            ...
                            <div className="mt-8 flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-10">
                                ...
                                <div className="w-full space-y-5 lg:w-[64%]">
                                    <p className="text-lg leading-relaxed text-[#4a5160]">
                                        Platform ini berawal dari kebutuhan akan
                                        sistem manajemen pembelajaran yang
                                        praktis dan mudah dipahami. Kami melihat
                                        tantangan besar bagi pengajar dalam
                                        memantau progres individu siswa di
                                        tengah padatnya kurikulum.
                                    </p>
                                    <p className="text-lg leading-relaxed text-[#4a5160]">
                                        Melalui pengembangan ini, kami fokus
                                        menciptakan tools yang tidak hanya
                                        berfungsi sebagai penyimpanan materi,
                                        tetapi juga sebagai alat analisis untuk
                                        memberikan dukungan belajar (intervensi)
