...
export default function DaftarTutorPage() {
    ...
    const selectedPendidikanLabel =
        pendidikanOptions.find((item) => item.value === tingkatPendidikan)
            ?.label || "";
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            ...
            if (
                pendidikanDropdownRef.current &&
                !pendidikanDropdownRef.current.contains(target)
            ) {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const payload: TutorRegisterPayload = {
                ...
                prodi: programStudi,
                cvPathUrl: cvFileName
                    ? `https://example.com/${cvFileName}`
    ...
    return (
        <div className="min-h-screen overflow-y-auto bg-gradient-to-br from-[#f7f6ff] to-white px-4 py-8 sm:px-6 sm:py-10">
            <div className="mx-auto w-full max-w-[560px]">
                <h1 className="mb-6 text-center text-3xl font-bold text-[#21212b]">
                    Daftar Tutor
                </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <section className="rounded-2xl border border-[#eceaf4] bg-white p-5 shadow-sm">
                        <h2 className="mb-3 text-base font-semibold text-[#21212b]">
                            Data Diri
                        </h2>
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <p className="mt-1 text-[10px] text-[#8a8a96]">
                                    Tulis nama lengkap sesuai dokumen Kartu
                                    Tanda Penduduk (KTP)
                                </p>
                            </div>

                            <div>
                                <p className="mb-1.5 block text-xs font-medium text-[#21212b]">
                                    Jenis Kelamin
                                </p>
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setNamaUniversitas(e.target.value)
                                    }
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    <span>
                                        {cvFileName ||
                                            "Unggah dalam format .pdf. Maksimum 10MB"}
                                    </span>
