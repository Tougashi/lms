                    ...
                    <div className="mt-4 rounded-xl border border-[#e4e2eb] bg-white px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <div className="h-14 w-14 rounded-full border border-[#e9e7f2] bg-[#d6d8df]" />
                          <button
                            type="button"
                        ...
                        <div>
                          <p className="text-base font-semibold text-[#202126]">Admin</p>
                    ...
                    <div className="mt-4 rounded-xl border border-[#e4e2eb] bg-white p-4">
                      ...
                      <div className="mt-4 grid gap-4 text-sm sm:grid-cols-2">
                        <div>
                          ...
                          <p className="mt-1 font-medium text-[#202126]">Santoso</p>
                        </div>
                        <div>
                          <p className="text-xs text-[#7d8291]">Email</p>
                          <p className="mt-1 font-medium text-[#202126]">administrator@gmail.com</p>
                        </div>
                        <div>
                          <p className="text-xs text-[#7d8291]">Jenis Kelamin</p>
                          <p className="mt-1 font-medium text-[#202126]">Pria</p>
                        </div>
                        <div>
                          <p className="text-xs text-[#7d8291]">Nomor WhatsApp</p>
                          <p className="mt-1 font-medium text-[#202126]">+62 8812278734</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 rounded-xl border border-[#e4e2eb] bg-white p-4">
                      ...
                      <div className="mt-4 grid gap-4 text-sm sm:grid-cols-2">
                        <div>
                          ...
                          <p className="mt-1 font-medium text-[#202126]">admin</p>
                        </div>
                        <div>
                          <p className="text-xs text-[#7d8291]">Passwords</p>
                          <p className="mt-1 font-medium text-[#202126]">ad****</p>
                        </div>
                      </div>
                    </div>
                  </>
