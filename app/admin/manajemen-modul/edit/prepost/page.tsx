...
function EditModulPrePostContent() {
      ...
      try {
        ...
        try {
          ...
          if (posttest?.id) {
            ...
            const pSettings = (posttest as any).posttestSettings;
            if (pSettings?.length) {
  ...
  const handleSaveSettings = useCallback(async () => {
    ...
    try {
      ...
      if (posttestId) {
        await adminPosttestApi.updateSettings(posttestId, { duration: posttestDuration, countShownQuestions: posttestCountShown });
      }
